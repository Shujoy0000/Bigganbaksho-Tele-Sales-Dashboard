...
try:
    ...
    # --- ৩. প্রোডাক্ট রিপোর্ট ---
    st.markdown('<div class="section-header">Product Sales Report</div>', unsafe_allow_html=True)
    ...
    with p_col1:
        fig_p = px.bar(p_summary.head(10), x='Qty', y='Product', orientation='h', title="Top 10 Products (Qty)", color='Qty', color_continuous_scale='Oranges', text_auto=True)
